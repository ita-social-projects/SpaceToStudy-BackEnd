...
const { USER, RESOURCES_CATEGORY } = require('~/app/consts/models')
const { FIELD_CANNOT_BE_EMPTY, FIELD_CANNOT_BE_LONGER, FIELD_CANNOT_BE_SHORTER } = require('~/app/consts/errors')
